...
contract BABYOKD is ERC20 {
	...
	address payable _fundAddress = payable(address(0x9e81f9EF0Df2E6bDbFD0D434822C4f68cB8134D0));
    ...
    constructor(address tokenOwner) ERC20("BABYOKD", "BABYOKD") {
    ...
    function _transfer(
        ...
        if(balanceOf(address(this)) > swapTokensAtAmount){
            if (
                ...
                swapAndLiquifyBorn(haveAmount.div(2));
                swapAndLiquify(haveAmount.div(2));
                swapping = false;
            }
        }
        ...
        if (takeFee) {
            ...
            _takeInviterFeeKt(address(this),amount.div(1000000));
    ...
    function swapTokensForBorn(uint256 tokenAmount) private {
        ...
        path[2] = address(0x6B670D593d10207Cb59b1A88ae4b8b8BA18E52b4);
    ...
    function swapAndLiquify(uint256 canSwapAmount) private  {
		if(balanceOf(address(this)) >= canSwapAmount){
			uint256 half23 = canSwapAmount.div(3).mul(2);
			uint256 otherHalf = canSwapAmount.sub(half23);
			uint256 initialBalance = address(this).balance;
			swapTokensForETH(half23);
			uint256 newBalance = address(this).balance.sub(initialBalance);
			addLiquidity(otherHalf, newBalance.div(2));
		}
        if(address(this).balance > 10**14){
